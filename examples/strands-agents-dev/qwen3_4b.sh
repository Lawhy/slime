...
CUSTOM_ARGS=(
   --custom-generate-function-path examples.strands-agents-dev.generate_with_strands.generate
   --custom-rm-path examples.strands-agents-dev.generate_with_strands.reward_func
)
