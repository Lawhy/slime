...
This code is adapted from `camel-ai`: https://github.com/camel-ai/camel/blob/master/camel/interpreters/subprocess_interpreter.py

Due to compatibility issues, for example I just copied the code to here for code execution need.
"""
...
class CodeInterpreter:
    r"""CodeInterpreter is a class for executing code files or code
    ...
    def run(
        ...
        Raises:
            ValueError: If the user declines to run the code or if the
